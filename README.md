# 📘 README — Processing and Comparing 3,880 Growth Curves

## **1. `clean_growth_curves.py`**
...
## **2. `ddtw_matrix.py`** (Derivative Dynamic Time Warping)
...
1. **Group growth curves by experiment**
   Based on the prefix before the first “.” in column names.

2. **Compute pairwise distances within each experiment**
...
3. **Select the top 25% most similar replicates**
